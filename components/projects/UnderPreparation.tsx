...
export default function UnderProcessing() {
    return (
        <motion.div
            ...
            className='grid grid-cols-1 lg:grid-cols-2 place-content-center md:-mt-10 lg:-mt-5 mx-5 md:mx-auto overflow-y-hidden h-[20em] w-fit bg-[#f8f4ff] dark:bg-[#15151c] shadow-2xl rounded-3xl transition-colors duration-300'
        >
            <div className='flex items-center px-4'>
                <h1 className={`${orbitronFont.className} text-xl lg:text-2xl text-gray-500 dark:text-gray-400`}>
